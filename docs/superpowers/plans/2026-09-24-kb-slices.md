...
- Kind: enabling
- Check: an Opus review of the code under `src/kb/` against `CLAUDE.md` after slices 63 to 68 is in this plan's log, and every refactor it calls for is a slice of its own with a check -> the log entry and those slices
...
- Kind: enabling
- Check: an Opus review of `src/kb/` against `CLAUDE.md` after slices 70 to 75 is in this plan's log, and every refactor it calls for is a slice of its own with a check -> the log entry and those slices
- Observable: Anyone can read whether slices 70 to 75 kept the code in the shape CLAUDE.md sets.
- Unknown: none
- Needs: none
- Status: planned
...
- Kind: enabling
- Check: an Opus review of `src/kb/` against `CLAUDE.md` after slices 77 to 82 is in this plan's log, and every refactor it calls for is a slice of its own with a check -> the log entry and those slices
